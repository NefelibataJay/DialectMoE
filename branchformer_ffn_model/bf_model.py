...
class AEDModel(torch.nn.Module):
    ...
    def forward(
        ...
        # ASR Encoder
        if self.use_branch:
            asr_encoder_output, encoder_mask = self.asr_encoder(encoder_input, mask,)
        else:
            assert per_encoder_output is not None
            asr_encoder_output, encoder_mask = self.asr_encoder(per_encoder_output, mask)
        ...
        loss = loss_ctc + loss_att + loss_domain
    ...
    def attention_rescoring(
        ...
        hyps, encoder_out = self._ctc_prefix_beam_search(
            speech, speech_lengths, beam_size, context_graph)
